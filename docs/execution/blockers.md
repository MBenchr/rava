...
| H-016 | Stockage commandes Supabase — **socle technique levé le 2 août 2026** | La persistance, le journal canonique, le rôle runtime dédié et l'isolation Eclipse/ṬĀQA sont en place | Conserver la preuve d'une commande Stripe de recette et de son replay dès que H-013 autorise un paiement réel | Écriture ṬĀQA autorisée, écriture Eclipse refusée, parcours propriétaire refusé ; commande réelle encore liée à H-013 |
