...
export async function generateMetadata({
  ...
  return buildProductMetadata("seuil-01", "fr", finishId);
}
    ...
    <>
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify(buildProductStructuredData("seuil-01", "fr")),
        }}
      />
      <ProductPage locale="fr" productId="seuil-01" initialFinishId={initialFinishId} />
    </>
  );
}
