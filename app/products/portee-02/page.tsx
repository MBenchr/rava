...
export async function generateMetadata({
  ...
  return buildProductMetadata("portee-02", "en", finishId);
}
    ...
    <>
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify(buildProductStructuredData("portee-02", "en")),
        }}
      />
      <ProductPage locale="en" productId="portee-02" initialFinishId={initialFinishId} />
    </>
  );
}
