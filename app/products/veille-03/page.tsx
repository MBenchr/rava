...
export async function generateMetadata({
  ...
  return buildProductMetadata("veille-03", "en", finishId);
}
    ...
    <>
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify(buildProductStructuredData("veille-03", "en")),
        }}
      />
      <ProductPage locale="en" productId="veille-03" initialFinishId={initialFinishId} />
    </>
  );
}
